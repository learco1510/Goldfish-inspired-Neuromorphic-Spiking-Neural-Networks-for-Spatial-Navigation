...
class BVC_NAV:
    ...
    def __init__(self,Path,m_tau,steer_thres,telen_neurons,ang_bin,corals_pos,Goal_pos,agent_init_pos,df,eps,free_turn_bins,max_bins_turn,seed,sim_time,sim_num,plt,vid):
    ...
    def buildModel(self):
        ...
        n_neuron_prop = np.round(np.array([20 / 132,
                                           35 / 196]) * telen_neurons*10)  # proportional n: vel/hd/speed, BVC
