...
class BVC_NAV:
    ...
    def __init__(self,Path,m_tau,RateScale,steer_thres,telen_neurons,ang_bin,corals_pos,Goal_pos,agent_init_pos,df,eps,free_turn_bins,max_bins_turn,seed,sim_time,sim_num,plt,vid):
    ...
    def buildModel(self):
        ...
        def getGoalDirection(t,x):
            ...
            elif abs(x)<4*self.eps: #if HP is as Goal's HP:
        ...
        with self.model:
            ...
            npos = nengo.Ensemble(n_neurons, dimensions=2,
